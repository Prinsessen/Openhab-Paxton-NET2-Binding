...
# OpenHAB Git Auto-Push Script (Excludes HTML directory)
# This script automatically commits and pushes changes to the git repository
# HTML directory is excluded from commits

# Configuration
REPO_DIR="/etc/openhab"
LOG_FILE="/var/log/openhab/git-autopush-no-html.log"
...
log_message "Auto-push completed successfully (html directory excluded)"
exit 0
