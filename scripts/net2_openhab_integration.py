...
Group Net2 "Paxton Net2" <lock>
Group Net2_Doors "Net2 Doors" <door> (Net2)
Group Net2_Users "Net2 Users" <user> (Net2)
Group Net2_Security "Net2 Security" <alarm> (Net2)
Group Net2_Stats "Net2 Statistics" <chart> (Net2)
