...
parser = argparse.ArgumentParser(description='Net2 door control --id <Door-ID>')
...
data = {"DoorId": id, "RelayFunction": {"RelayId": RelayId, "RelayAction": RelayAction,
                                            "RelayOpenTime": RelayOpenTime}, "LedFlash": LedFlash}
